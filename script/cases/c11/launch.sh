...
function interference {
  ssh client1 'cd eval_script/script/cases/c11/ && ./noisy-neighbor.sh' > /dev/null 2>&1 &  
  ssh client2 'cd eval_script/script/cases/c11/ && ./noisy-neighbor.sh' > /dev/null 2>&1 &  
...
function parties {
  ...
  sudo ../../comparsion/parties_for_native.py $LOG_DIR/c11/ &
  sleep 90
