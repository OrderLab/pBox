...
QOS = {"front_1": 15000000, "back_1": 500000000000}
...
INTERVAL  = 1  # Frequency of monitoring, unit is second
...
ECORES    = [i for i in range(1,7,1)] # unallocated cores
...
FF        = open("/tmp/gabage.txt", "w")    # random outputs
